...
public class Get_tripRequest_Fastest_TestStepDefinition {	
	...
	final static Logger LOGGER=LogManager.getLogger(ComplexGetData_TestStepDefinition.class);
	 RestAssuredExtensionv2 restAssuredExtensionv2;
		...
		public Get_tripRequest_Fastest_TestStepDefinition(APITestContext testContext) {
			super();
			restAssuredExtensionv2=testContext.getRestAssuredExtensionv2();
		}
		

		@When("I perform GET operation for  fastest slow {string}")
...
//		         APIVerification.responseTimeValidation(response);
		...
		@When("I perform GET operation for  fastest fast {string}")
...
//			        test.log(Status.INFO, "My test has been ended.....");
		...
		@When("I perform GET operation for  departure Time {string}")
...
//		        test.log(Status.INFO, "My test has been ended....."); 
		...
		@When("I perform GET operation for  arrival Time {string}")
